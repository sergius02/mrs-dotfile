...
plugins=(git zsh-autosuggestions sudo zsh-interactive-cd docker docker-compose)
...
alias updateaur='yay -Syu --noconfirm'
...
export JDTLS_HOME=/home/sergio/.config/nvim/jdt/jdt-server
